...
export default function DoctorDetail({ params }) {
    const DoctorDetail = doctors.find((doctor) => doctor.id == params.id)
    return (
                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 relative w-full lg:h-auto h-64 object-cover object-center rounded">
                            <Image
                                fill={true}
                                src="https://images.unsplash.com/photo-1584467735867-4297ae2ebcee?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8ZG9jdG9yfGVufDB8fDB8fHww"
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <p className="leading-relaxed my-9">
                            ...
                            <div className="flex my-9">
                               ...
                               <Button className="flex ml-auto border-0 py-2 px-6">
                                Book Appointment
                               </Button>
